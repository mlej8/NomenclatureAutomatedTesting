...
public class BrowsePageTest extends TestBase {
	...
	public void setUp() {
		/*
		 * The constructor of BrowsePage calls the initialization method from TestBase
		 * Class which initializes driver, implicit wait, actions, etc. We are using a
		 * fresh new Browser for every test cases in order to avoid having cached too
		 * many cookies or browser crashing/dying due to running out of memory or other
		 * reasons
		 */
	...
	public void subTreeOrder() {
		...
		// Ensure the selected term appears in the tree (left) and in the detail (right)
		// is the same
		...
		// TODO: This test is a bit long and very complex.... This is an integration
		// test and should not be written as an unit test
	...
	public void chairFRTest() {
		...
		Assert.assertTrue(
				NomenclatureUtil.containsWord("Le Dictionnaire descriptif et visuel d'objets de Parcs Canada"));
